 ...
 * @author user
 */
public class pre_prestamo extends Pantalla {
...
////////////////////////////////////////////////////////////////////////    private Texto tex_buscar = new Texto();
    ...
    public pre_prestamo() {
        ...
        if (lis_plan != null && !lis_plan.isEmpty()) {
            ...
            bar_botones.agregarBoton(bot_calcular_tabla_amortizacion);
            bar_botones.agregarBoton(bot_pago_prestamo);
            //////////////////--------------
...
//            gri_busca_num.getChildren().add(bot_busca);
            ...
            tab_tabla2.getColumna("num_ipdpr").setLectura(true);
            tab_tabla2.getColumna("num_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("fecha_ipdpr").setLectura(true);
            tab_tabla2.getColumna("fecha_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("capital_ipdpr").setLectura(true);
            tab_tabla2.getColumna("capital_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("interes_ipdpr").setLectura(true);
            tab_tabla2.getColumna("interes_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("cuota_ipdpr").setLectura(true);
            tab_tabla2.getColumna("cuota_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("pagado_ipdpr").setLectura(true);
            tab_tabla2.getColumna("pagado_ipdpr").setValorDefecto("false");
            tab_tabla2.getColumna("doc_banco_ipdpr").setLectura(true);
            tab_tabla2.getColumna("doc_banco_ipdpr").setEtiqueta();
            tab_tabla2.getColumna("ide_tecba").setLectura(true);
            tab_tabla2.getColumna("ide_tecba").setEtiqueta();
            tab_tabla2.getColumna("ide_cnccc").setLectura(true);
            tab_tabla2.getColumna("ide_cnccc").setEtiqueta();
            tab_tabla2.getColumna("ide_cccfa").setLectura(true);
            tab_tabla2.getColumna("ide_cccfa").setEtiqueta();
...
////    }
    ...
    public void guardar() {
        if (tab_tabla1.isFilaInsertada()) {
            if (tab_tabla1.getValor("genera_asiento_ipcpr").equals("true")) {
                if (validar()) {
                    generarAsientoPrestamo();
                }
            } else {
                if (tab_tabla2.getTotalFilas() == 0) {
                    utilitario.agregarMensajeInfo("No se puede guardar", "debe generar la tabla de Amortización");
                } else {
////                    calcularSecuenciaPrestamo();
                    tab_tabla1.guardar();
                    tab_tabla2.guardar();
