/*
 * En una sola clase se peuede realizar tdas las transacciones para bodega ingreso egreso
 * o tambien para el control de produccion
 */
package paq_bodega;
 ...
 *
 */
public class pre_bodega_comprobante extends Pantalla {
    ...
    private Combo com_tipo_transaccion = new Combo();
    String factura ="";
    String valor_orden = "";
    ...
    public pre_bodega_comprobante() {
        
        com_tipo_transaccion.setId("com_tipo_transaccion");
        com_tipo_transaccion.setCombo(ser_inventario.getTipoTransaccion());
