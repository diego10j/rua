 ...
 * @author Diego
 */
public class cls_anexo_transaccional_electronicos {
...
//                double totalVentas = tab_estab.getSumaColumna("total_ventas") - totalNotasCredito;
                raiz.appendChild(crearElemento("totalVentas", null, utilitario.getFormatoNumero("0")));
                ...
                if (opcionAnexo.equals("1") || opcionAnexo.equals("2")) {
                    ...
                    for (int i = 0; i < tab_compras.getTotalFilas(); i++) {
                        ...
                        detalleCompras.appendChild(crearElemento("fechaRegistro", null, getFormatoFecha(tab_compras.getValor(i, "fecha_trans_cpcfa"))));
...
//                        } catch (Exception e) {
//                        }
                        ventaEst.appendChild(crearElemento("ventasEstab", null, utilitario.getFormatoNumero("0")));
                        ventaEst.appendChild(crearElemento("ivaComp", null, utilitario.getFormatoNumero("0")));
                    }
