...
public class cls_formulario104 {
    ...
    private String v401, v402, v403, v404, v405, v406, v407, v408, v409, v411, v412, v413, v414, v415, v416, v417, v418, v419, v421, v422, v429, v431, v480, v481, v482, v483, v484, v485, v499;
    ...
    public void Formulario104(String anio, String mes) {
        try {
            ...
            if (tab_empresa.getTotalFilas() == 1) {
                ...
                cabecera.appendChild(crearElemento("codigo_version_formulario", null, "04201201"));
    ...
    private String consultarAlternoCompras(String alterno) {
        ...
        List lis_sql = utilitario.getConexion().consultar("SELECT SUM(df.valor_cpdfa) as valor "
                ...
                + " AND f.fecha_trans_cpcfa BETWEEN '" + fecha_inicio + "' AND '" + fecha_fin + "' ");
