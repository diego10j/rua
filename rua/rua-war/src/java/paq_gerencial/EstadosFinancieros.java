...
public class EstadosFinancieros extends Pantalla {
    ...
    public EstadosFinancieros() {
        ...
        mep_menu.setMenuPanel("ESTADOS FINANCIEROS CONTABLES", "20%");
    ...
    public void dibujarLibroMayor() {
        ...
        bot_imprimir_cuentas.setMetodo("consultarBase");
...
public void consultarBase(){
    conPersistencia.setUnidad_persistencia("rua_meca_dbk");
    conPersistencia.NOMBRE_MARCA_BASE = "postgres";
    Tabla tab_prueba= new Tabla();
    tab_prueba.setConexion(conPersistencia);
    tab_prueba.setTabla("prod_color", "ide_prcol", 45);
    tab_prueba.imprimirSql();
}
