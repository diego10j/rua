 ...
 *
 */
public class pre_comp_inv_nri extends Pantalla {
    ...
    public pre_comp_inv_nri() {
       ...
       // tab_tabla1.getColumna("ide_georg").setCombo("gen_organigrama", "ide_georg", "nombre_georg", "");
        ...
        tab_tabla2.getColumna("ide_inarti").setCombo(ser_inventario.getInventarioGrupo(utilitario.getVariable("p_prod_grupo_nota_recibido_interno")));
