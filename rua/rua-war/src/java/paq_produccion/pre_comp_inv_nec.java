 ...
 *
 */
public class pre_comp_inv_nec extends Pantalla {
    ...
    public pre_comp_inv_nec() {
       ...
       // tab_tabla1.getColumna("ide_georg").setCombo("gen_organigrama", "ide_georg", "nombre_georg", "");
        ...
        tab_tabla1.setCondicion("ide_intti= "+ utilitario.getVariable("p_prod_nota_entrega_clientes"));
        tab_tabla1.dibujar();
...
////        tab_tabla2.getColumna("ide_cccfa").setLectura(true);
    ...
    public void insertar() {
        if (tab_tabla1.isFocus()){
            tab_tabla1.insertar();
            TablaGenerica tab_secuen = utilitario.consultar(ser_produccion.getSecuencialModulo(utilitario.getVariable("p_prod_num_mod_nota_entrega_clientes")));
           // ser_produccion.getSecuencialNumero(Integer.parseInt(tab_secuen.getValor("longitud_secuencial_gemos")), Integer.parseInt(tab_secuen.getValor("tamano")));
            ...
            tab_tabla1.setValor("ide_intti", utilitario.getVariable("p_prod_nota_entrega_clientes"));
    ...
    public void guardar() {
      //  if (validar()) {
            if (tab_tabla1.isFilaInsertada()) {
                utilitario.getConexion().ejecutarSql(ser_produccion.getActualizarSecuencial(utilitario.getVariable("p_prod_num_mod_nota_entrega_clientes")));
