 ...
 *
 */
public class pre_comp_inv_nei extends Pantalla {
    ...
    String factura ="";
    String valor_orden = "";
    private VisualizarPDF vipdf_nota_entrega_inter = new VisualizarPDF();
    ...
    public pre_comp_inv_nei() {
      ...
      //  tab_tabla1.getColumna("ide_inbod").setVisible(false);
        ...
        tab_tabla1.setCondicion("ide_intti= "+ utilitario.getVariable("p_prod_nota_entrega_interna"));
        tab_tabla1.dibujar();
        ...
        tab_tabla2.getColumna("ide_inarti").setCombo(ser_inventario.getInventarioGrupo(utilitario.getVariable("p_prod_grupo_nota_entrega_interna")));
...
////        tab_tabla2.getColumna("ide_cccfa").setLectura(true);
       ...
       /* Boton bot_busca_orden = new Boton();
        ...
        vipdf_nota_entrega_inter.setId("vipdf_nota_entrega_inter");
        vipdf_nota_entrega_inter.setTitle("NOTA DE ENTREGA INTERNA");
        agregarComponente(vipdf_nota_entrega_inter);
    ...
    public void generarPDFnota(){
        ...
        if (tab_tabla1.getValorSeleccionado() != null) {
            ...
            utilitario.agregarMensajeInfo("Seleccione una Nota de Entrega Interna", "");
        }
    }
    ...
    public void buscarTransaccion() {
        if (tex_num_transaccion.getValue() != null && !tex_num_transaccion.getValue().toString().isEmpty()) {
            tab_tabla1.setCondicion("ide_incci=" + tex_num_transaccion.getValue() +" and ide_intti ="+ utilitario.getVariable("p_prod_nota_entrega_interna"));
    ...
    public void buscarnombTransaccion() {
        ...
        if (tex_nomb_transaccion.getValue() != null) {
            tab_tabla1.setCondicion("observacion_incci ilike '%" + tex_nomb_transaccion.getValue()+"%'" + " and ide_intti ="+ utilitario.getVariable("p_prod_nota_entrega_interna"));
            tab_tabla1.ejecutarSql();
            tab_tabla2.ejecutarValorForanea(tab_tabla1.getValorSeleccionado());
            utilitario.addUpdate("tab_tabla1,tab_tabla2");
        }
    ...
    public void insertar() {
        if (tab_tabla1.isFocus()){
            tab_tabla1.insertar();
            TablaGenerica tab_secuen = utilitario.consultar(ser_produccion.getSecuencialModulo(utilitario.getVariable("p_prod_num_mod_nota_entrega_interna")));
           // ser_produccion.getSecuencialNumero(Integer.parseInt(tab_secuen.getValor("longitud_secuencial_gemos")), Integer.parseInt(tab_secuen.getValor("tamano")));
            ...
            tab_tabla1.setValor("ide_intti", utilitario.getVariable("p_prod_nota_entrega_interna"));
...
//                }
    ...
    public VisualizarPDF getVipdf_nota_entrega_inter() {
        return vipdf_nota_entrega_inter;
    }

    public void setVipdf_nota_entrega_inter(VisualizarPDF vipdf_nota_entrega_inter) {
        this.vipdf_nota_entrega_inter = vipdf_nota_entrega_inter;
    }
