 ...
 * @author djacome
 */
public class pre_retenciones_inspectoria extends Pantalla {
    ...
    public pre_retenciones_inspectoria() {
    ...
    public void dibujarConsolidado() {
        ...
        tab_tabla.setSql(ser_retencion.getSqlConsolidadoRentaInspectoria(cal_fecha_inicio.getFecha(), cal_fecha_fin.getFecha()));
        ...
        tab_tabla1.setSql(ser_retencion.getSqlConsolidadoIvaInspectoria(cal_fecha_inicio.getFecha(), cal_fecha_fin.getFecha()));
