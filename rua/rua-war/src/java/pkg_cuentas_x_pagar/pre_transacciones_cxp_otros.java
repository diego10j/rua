 ...
 * @author user
 */
public class pre_transacciones_cxp_otros extends Pantalla {
    ...
    public pre_transacciones_cxp_otros() {
        ...
        tab_tabla1.setTabla("cxp_cabece_transa", "ide_cpctr", 1);
        tab_tabla1.getColumna("ide_cpttr").setCombo("cxp_tipo_transacc", "ide_cpttr", "nombre_cpttr", "");
        tab_tabla1.getColumna("fecha_trans_cpctr").setValorDefecto(utilitario.getFechaActual());
        ...
        tab_tabla2.setTabla("cxp_detall_transa", "ide_cpdtr", 2);
        tab_tabla2.getColumna("ide_cpcfa").setVisible(false);
        tab_tabla2.getColumna("ide_cpttr").setCombo("cxp_tipo_transacc", "ide_cpttr", "nombre_cpttr", "");
        ...
        tab_tabla2.getColumna("fecha_trans_cpdtr").setValorDefecto(utilitario.getFechaActual());
    ...
    public void insertar() {
        if (aut_filtro_persona.getValor() != null) {
            ...
            if (tab_tabla2.isFocus()) {
                tab_tabla2.insertar();
                tab_tabla2.setValor("ide_cpcfa", tab_tabla1.getValor("ide_cpcfa"));
            }
        } else {
