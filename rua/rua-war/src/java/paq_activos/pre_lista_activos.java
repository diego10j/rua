...
public class pre_lista_activos extends Pantalla {
    ...
    public pre_lista_activos() {
        ...
        tab_lista.getColumna("ide_inarti").setFiltro(true);
        ...
        tab_lista.getColumna("ide_geper").setFiltro(true);
        tab_lista.getColumna("ide_geper").setAutoCompletar();
        tab_lista.getColumna("cod_anterior_acafi").setFiltro(true);
        ...
        tab_lista.getColumna("ide_geubi").setFiltro(true);
        ...
        tab_lista.getColumna("ide_cndpc").setFiltro(true);
        ...
        tab_lista.getColumna("inv_ide_inarti").setAutoCompletar();
        tab_lista.getColumna("inv_ide_inarti").setFiltro(true);
        tab_lista.getColumna("act_ide_acuba").setCombo("act_ubicacion_activo","ide_acuba","nombre_acuba","");
        tab_lista.getColumna("act_ide_acuba").setAutoCompletar();
        tab_lista.getColumna("act_ide_acuba").setFiltro(true);
