...
public class pre_modifica_documento extends Pantalla {
    ...
    public boolean validarDocumento() {
        ...
        if (tab_cab_documento.getValor("ide_cntdo") == null || tab_cab_documento.getValor("ide_cntdo").isEmpty()) {
        ...
        if (tab_cab_documento.getValor("numero_cpcfa") == null || tab_cab_documento.getValor("numero_cpcfa").isEmpty()) {
            utilitario.agregarMensajeError("Error al guardar el Documento", "Debe ingresar el N̼mero del Documento");
            return false;
        }
