...
public class pre_documentosCxP extends Pantalla {
    ...
    public void dibujarSaldarAnticipo() {
        ...
        tab_tabla1.setSql(ser_cuentas_cxp.getSqlDocumentosPorPagarAnticipos(cal_fecha_inicio.getFecha(), cal_fecha_fin.getFecha()));
    ...
    public void aceptarAnticipoCxp() {
        if (validarAnticipoEmpleado()) {
            ...
            for (Fila actual : tab_tabla1.getSeleccionados()) {
                ...
                utilitario.getConexion().agregarSql("UPDATE cxp_detall_transa SET ide_cnccc=" + ide_cnccc + " where ide_cpdtr=" + ide_cpdtr + " and ide_cnccc is null");
                utilitario.getConexion().agregarSql("UPDATE cxp_cabece_factur SET ide_cnccc=" + ide_cnccc + " where ide_cpcfa=" + actual.getCampos()[1] + " and ide_cnccc is null");
    ...
    public void abrirGeneraAsiento() {
        if (tab_tabla1.getFilasSeleccionadas() != null && tab_tabla1.getFilasSeleccionadas().length() > 0) {
            ...
            if (mep_menu.getOpcion() == 8) {
                ...
                asc_asiento.setAsientoDocumentosCxP(ide_cpcfa);
            } else {
