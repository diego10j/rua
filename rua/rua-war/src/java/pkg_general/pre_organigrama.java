...
public class pre_organigrama extends Pantalla {
    ...
    public pre_organigrama() {
        ...
        tab_tabla1.setTabla("gen_organigrama", "ide_georg", 1);

        //  tab_tabla1.getColumna("nivel_georg").setCombo(utilitario.getListaNiveles());
        tab_tabla1.setCampoNombre("nombre_georg"); //Para que se configure el arbol
        tab_tabla1.setCampoPadre("gen_ide_georg"); //Para que se configure el arbol
