 ...
 */
public class pre_reporte_visualizador extends Pantalla {
     private Tabla tab_color=new Tabla();
    
    public  pre_reporte_visualizador (){
        tab_color.setId("tab_color");
        tab_color.setTabla("sis_reporte_visual","ide_repv",1);
        tab_color.dibujar();
