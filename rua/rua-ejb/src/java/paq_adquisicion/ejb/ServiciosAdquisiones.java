...
public class ServiciosAdquisiones {
    ...
    public String getUsuarioCaja(String ide_usua) {
        String sql = "";
        sql = "select a.ide_ademple, cedula_ademple, nombres_ademple, b.detalle_cocaj , c.observacion_ccdaf,b.ide_cocaj,a.ide_gtemp from adq_empleado a\n"
                + "left join (select ide_cxcaem, a.ide_ademple, b.detalle_cocaj,b.ide_cocaj from cxc_caja_empleado a left join cont_caja b on a.ide_cocaj = b.ide_cocaj where activo_cxcaem = true) b on a.ide_ademple = b.ide_ademple\n"
    ...
    public String getFacturasVentas(String condicion) {
        String sql = "";
        sql = "select a.ide_cccfa,secuencial_cccfa,fecha_emisi_cccfa,a.ide_geper,identificac_geper,nom_geper,total_cccfa,a.ide_sucu\n"
    ...
    public String getdetalleFacturaVenta(String condicion) {
        String sql = "";
        sql = "select ide_ccdfa,b.ide_inarti,b.nombre_inarti,cantidad_ccdfa, precio_ccdfa, total_ccdfa as subtotal\n"
