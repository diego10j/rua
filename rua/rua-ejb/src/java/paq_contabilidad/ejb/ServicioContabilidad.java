...
public class ServicioContabilidad {
     ...
     * @param modulo recibe el codigo del Modulo por el cual desea clasificar el
     * estado
    ...
    /**
     * Metodo que devuelve la Cuenta Cantable por realizaqr transacciones filtra
     * cuentas contables por Año fiscal vigente
     *
     ...
     *
     * @param ide_geani recibe el Año fiscal para la generación del balance
     * inicial
     */
    ...
    /**
     * Metodo que devuelve la suma del debe y el haber por cuenta contable y
    ...
    /**
     * Metodo que devuelve los asientos contables con las respectivas sumas al
     * debe y al haber
     *
     * @return String sql de los movimientos contables
     */
...
+" ) a group by con_ide_cocac");
    ...
    /**
     * Metodo que devuelve el sql para consultar lso anticpio pendientes de
     * contabilizar de lso empleados
     *
     ...
     * @return String sql para contar anticpios pendientes
     */
    public String getConsultaRetencioneCxC(String fecha_inicio, String fecha_final) {
        String sql = "select nom_sucu,ide_cndre,nombre_cncim,casillero_cncim,fecha_emisi_cncre,numero_cncre,identificac_geper,\n"
                ...
                + "inner join sis_sucursal f on a.ide_sucu=f.ide_sucu\n"
                + "where fecha_emisi_cncre BETWEEN '"+fecha_inicio+"' and '"+fecha_final+"'\n"
                + "and b.ide_cnere=0\n"
