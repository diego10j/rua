...
//
        ...
        // PRODUCCION = 14
          ...
          lis_parametros.add(new Parametro("14", "p_prod_numero_proforma", "Indica el numero secuencial para cualquier documento", "1", "gen_modulo", "ide_gemod", "detalle_gemod"));
          lis_parametros.add(new Parametro("14", "p_prod_num_sec_orden_producion", "Indica el numero secuencial para cualquier documento de orden de produccion", "3", "gen_modulo", "ide_gemod", "detalle_gemod")); 
          lis_parametros.add(new Parametro("14", "p_prod_num_mod_control_produccion", "Indica el numero secuencial para cualquier documento de control de produccion", "4", "gen_modulo", "ide_gemod", "detalle_gemod"));
          lis_parametros.add(new Parametro("14", "p_prod_num_mod_cronograma_produccion", "Indica el numero secuencial para cualquier documento del cronograma de produccion", "4", "gen_modulo", "ide_gemod", "detalle_gemod"));
          lis_parametros.add(new Parametro("14", "p_prod_num_mod_recepcion_mercaderia", "Indica el numero secuencial para cualquier documento de recepcion de mercaderia de produccion", "5", "gen_modulo", "ide_gemod", "detalle_gemod"));
