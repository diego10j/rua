...
public class ServicioPresupuesto {
     ...
     * @param tipo recibe el tipo 1 para cuentas tipo ingresos, 0 para cuentas
     * tipo egresos
    ...
    /**
     * Metodo que devuelve el Catalogo Presupuestario para de esta manera
     * desplegar en los autocompletar del aplicativo de esta manera no saturamos
     * los combos de consulta
     *
     * @param estado recibe el o los estados true y false, ejemplo: true o false
     * @return String SQL Clasificador Presupuestario solo para consulta de
     * autompletar
     */
    ...
    /**
     * Metodo que devuelve el POA a ser aprobado para la generacion del
    ...
    /**
     * Metodo que devuelve el valor del financiamiento inicial por fuente de
     * financiamiento
     *
     ...
     * @param tipo recibe 1 para cargar lso tramites presupuetsarios, recibe 2
     * para cargar por detalle de Presupuesto, 3 Compromiso para CXP
     * @return String SQL Valor inicial fuente de financiamiento
     */
     ...
     *
     * @param tipo recibe el tipo de sql requerido para 1 para seltabla, 2 para
     * un combo
    ...
    public void trigActualizaSaldosAnual(String tipo, String ide_pranu, String ide_geani) {
        ...
        if (tipo.equals("2")) {
            sql += " where a.ide_pranu in (" + ide_pranu + ")";
        }
    ...
    /**
     * Metodo que devuelve las subactividades presupuestarias de acuerdo al
     * programa
     *
     * @param programa recibe el o los estados true y false, ejemplo: true o
     * false
     * @return String SQL Clasificador Presupuestario solo para consulta de
     * autompletar
     */
     ...
     * autompletar
     */
    public String getSubactvidadesFuncionPrograma(String programa) {
        String sql = " select ide_prfup from pre_funcion_programa "
                + " where pre_ide_prfup in ("
                + " select ide_prfup from pre_funcion_programa "
                + " where pre_ide_prfup in ("
                + " select ide_prfup from pre_funcion_programa "
                ...
                + " union "
                + " select ide_prfup from pre_funcion_programa  "
                + " where pre_ide_prfup in ( select ide_prfup from pre_funcion_programa  where pre_ide_prfup in ( select ide_prfup from pre_funcion_programa  "
                + " where pre_ide_prfup =" + programa + " )  )"
                + " union"
                + " select ide_prfup from pre_funcion_programa  where pre_ide_prfup in ( select ide_prfup from pre_funcion_programa  "
                + " where pre_ide_prfup = " + programa + " ) "
                + " union"
                + " select ide_prfup from pre_funcion_programa  "
                + " where pre_ide_prfup = " + programa
    ...
    public String getMes(String estado, String sucu, String empr) {
        String sql = "select ide_gemes,nombre_gemes from gen_mes where activo_gemes in (" + estado + ") and ide_sucu=" + sucu + " and ide_empr=" + empr;
        return sql;
    }
