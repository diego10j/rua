...
public class ServicioPensiones extends ServicioBase {
    ...
    public String generarFacturaElectronica(String ide_recva) {
        ...
        if (tag.isEmpty() == false) {
            ...
            TablaGenerica tag_con_detalle = utilitario.consultar("        select ide_valdet_revad,a.IDE_TITULO_RECVAl, detalle_revad||' '||nombre_gemes as detalle_revad, cantidad_revad, precio_revad, total_revad, valor_descuento_revad, c.iva_inarti, c.ide_inarti\n"
                    ...
                    + "        left join (select ide_titulo_recval,nombre_gemes from rec_valores a,gen_mes b where a.ide_gemes= b.ide_gemes ) d on a.ide_titulo_recval = d.ide_titulo_recval\n"
    ...
    public String selectPenTemp(String codigo) {
       ...
       // System.out.println("imprimo sql para factura "+sql);
        return sql;
    ...
    public String gettranferencias(String periodo, String co, String num_cuenta, String moneda, String rec, String num_36, String c, String ciudad) {
        ...
        sql = "select '"+ co +"' as co,'"+ num_cuenta +"' as numero_cuenta,row_number() over(order by a.ide_titulo_recval )as numero_registro,a.ide_titulo_recval as codigo,codigo_geper as codigo_alumno,\n"
                + "'"+ moneda +"' as moneda,\n"
                + "        (case when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer ) end) )||'') = 1 then '000000000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 2 then '00000000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 3 then '0000000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end))\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 4 then '000000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 5 then '00000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 6 then '0000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 7 then '000000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 8 then '00000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 9 then '0000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 10 then '000'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "	   when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 11 then '00'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "	   when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 12 then '0'||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "	   when length(((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )||'') = 13 then ''||((case when cast(replace(total_recva||'','.','') as integer) is null then  0 else cast(replace(total_recva||'','.','') as integer) end) )\n"
                + "        end) as  valor,'"+ rec +"' as rec,'"+ num_36 +"' as num,' 'as kl,'  'as mn, 'C' as c2,\n"
                + "        (case when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 1 then '000000000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 2 then '00000000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 3 then '0000000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end))\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 4 then '000000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 5 then '00000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 6 then '0000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 7 then '000'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 8 then '00'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 9 then '0'||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
                + "        when length(((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )||'') = 10 then ''||((case when cast(codigo_geper as integer) is null then  0 else cast(codigo_geper as integer) end) )\n"
