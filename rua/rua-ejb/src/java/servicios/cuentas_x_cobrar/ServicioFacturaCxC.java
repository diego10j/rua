...
public class ServicioFacturaCxC extends ServicioBase {
     ...
     * @return ide_ccctr Cabecera de la Transaccion CxC
     */
    public String generarTransaccionFactura(TablaGenerica tab_cab_factura) {
        String ide_ccctr = "-1";
        TablaGenerica tab_cab_tran_cxc = new TablaGenerica();
        TablaGenerica tab_det_tran_cxc = new TablaGenerica();
        tab_cab_tran_cxc.setTabla("cxc_cabece_transa", "ide_ccctr", -1);
    ...
    /**
     * Genera Anticipo a Empleado Cliente
     *
     * @param ide_geper
    ...
    public String generarTransaccionAnticipo(String ide_geper, TablaGenerica tab_libro_banco, String ide_ccctr) {
        ...
        if (tab_libro_banco != null) {
            ...
            tab_det_tran_cxp.setValor("ide_ccttr", parametros.get("p_cxc_tipo_trans_anticipo"));//Tipo transaccion Anticipo     
    ...
    /**
     * Retorna todos los anticipos que se an realizado en la sucursal
     *
     * @return
     */
    public String getSqlAnticiposEmpleados() {
