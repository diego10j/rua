...
public class ServicioActivosFijos extends ServicioBase {
    ...
    public String getSqlListaActivosFijos(String tipo_persona, String persona, String tipo_estado, String estado, String ide_accls) {
        String sql = " select ide_acafi,nombre_accla AS CLASE,(case when act_ide_acafi is null then ide_acafi||' 1' else act_ide_acafi||' '||sec_masivo_acafi  end) as SECUENCIAL,"
        +" arti.nombre_inarti as TIPO_ACTIVO,i.nombre_inarti as SUBTIPO_ACTIVO,cantidad_acafi as CANTIDAD,codigo_barras_acafi,act_ide_acafi,d.nombre_acuba as AREA_UBICACION,j.nombre_acuba as SUBAREA_UBICACION,nombre_aceaf as ESTADO,"
...
"                where a.ide_empr=" + utilitario.getVariable("IDE_EMPR") + " and  a.ide_accls=2" + //BIENES DE CONTROL\n" +
