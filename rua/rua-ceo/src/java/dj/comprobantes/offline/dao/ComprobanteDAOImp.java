...
public class ComprobanteDAOImp implements ComprobanteDAO {
    ...
    public List<Comprobante> getComprobantesPorEstado(EstadoComprobanteEnum estado) throws GenericException {
        ...
        ResultSet res = null;
        try {
            String sql = "SELECT a.*,identificacion_empr,telefono_empr,fines_lucro_empr,mail_empr,RESOLUCION_EMPR,AGENTE_RET_RES_EMPR,REG_MICRO_EMPR,CONT_RIMPE_EMPR FROM sri_comprobante  a , sis_empresa b\n"
